...
- [ ] Create ad unit #4 — Banner 728×60 (mid-game) → replace slot `4444444444`
- [ ] Create ad unit #5 — Rectangle 300×250 (sidebar #2) → replace slot `5555555555`
- [ ] Create ad unit #6 — Skyscraper 160×600 (sidebar) → replace slot `6666666666`
- [ ] Create ad unit #7 — Leaderboard 728×90 (in-content) → replace slot `7777777777`
- [ ] Create ad unit #8 — Leaderboard 728×90 (sticky footer) → replace slot `8888888888`

## Pre-Publish Edits
- [x] Update canonical URL → `https://free-snake.org/`
- [x] Remove footer copyright placeholder
- [x] Add Privacy Policy (required for AdSense)
- [x] Rename `snake.html` → `index.html`
